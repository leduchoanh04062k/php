								...
								<?php foreach ($products as $pro): ?>
									...
									<div class="product_item is_new">
										...
										<div class="product_content">
											<div class="product_price"><del style="margin: 20px">$<?php echo number_format($pro['price'], 0, '', ','); ?></del><a href=""style="color: red;font-size:15px">$<?php echo number_format($pro['sale_price'], 0, '', ','); ?></a></div>
											<div class="product_name"><div><a href="<?php echo BASE_URL . "detail.php?id=" . $pro['id'] ?>"><?php echo $pro['name'] ?></a></div></div>
										</div>
