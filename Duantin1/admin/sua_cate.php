    ...
    <div class="page-wrapper">
      ...
      <div class="content-wrapper">
        <div class="content">            
                  <!-- Top Statistics -->
                 <div class="container">
  <h2 style="color: black">Categorys</h2>     
  ...
  <?php   
     ...
     <form action="" method="POST" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <input class="form-control" id="inputdefault" type="text" name="name" value="<?php echo $kq['name']; ?>">
        </div>
        <div class="form-group">
            <label for="inputsm">Description</label>
           <input class="form-control" id="inputdefault" type="text" name="description" value="<?php echo $kq['description']; ?>">
          </div>
        <div class="form-group">
          <label for="inputsm">Show_menu</label>
          <select name="show_menu" id="" class="form-control-2" value="<?php echo $kq['show_menu']  ?>">
        ...
        if(isset($_POST['save'])){
          ...
          if (empty($name) || empty($description)) {
            ...
            $sqlsua = "update categories set name='$name',description='$description',show_menu='$show_menu'where id ='$masua'";
