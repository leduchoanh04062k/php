           ...
           <th><?php echo $row['price']; ?></th>
            <th><?php echo $row['sale_price']; ?></th>
             <th><?php echo $row['detail']; ?></th>
               <td><img style="height: 50px; width: 50px" src="images/img_pro/<?php echo $row['feature_image']; ?>"></td>
                <th><?php echo $row['view_count']; ?></th>
          <th><a href="sua_pro.php?masua=<?php echo $row ['id']?>"><input type="submit" name=""
          value="Edit"></a></th>
      <th><a href="xoa_pro.php?maxoa=<?php echo $row ['id']?>"><input type="submit" name="" value="Delete" onclick="return confirm('ban co muon xoa k ?')" ></a></th>
        </tr>
      <?php }
       ?>
  </table><i class="fas fa-trash-alt"></i>
</div>
</div>
            </div>
