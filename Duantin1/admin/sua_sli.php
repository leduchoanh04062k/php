    ...
    <div class="page-wrapper">
     ...
     <form action="" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="form-group">
          ...
          <input class="form-control input-sm" id="inputsm" required="" type="file" name="images" value="<?php echo $kq['images']; ?>"><?php echo $kq['images']; ?>
        </div>
        <div class="form-group">
          <label for="inputsm">Status</label>
          <select name="status" id="" class="form-control" value="<?php echo $kq['status']; ?>"><?php echo $kq['status']; ?>
     ...
     <?php   
        if(isset($_POST['save'])){
          ...
          move_uploaded_file($tmpA, 'images/img_sli/'.$nameA);
          $status=$_POST['status'];
           $sqlsua = "update sliders set images='$nameA',status='$status'where id ='$masua'";
