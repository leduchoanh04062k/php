        ...
        <div class="container">
         ...
         <form action="" method="POST" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input class="form-control" id="inputdefault" type="text" name="cate_name">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select name="show_menu" id="" class="form-control-2">
          ...
          if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($_POST[''])) {
              $error['cate_name'] ="ban can nhap ten danh muc";
            }else{
              $cate_name=$_POST['cate_name'];
            }
            if (empty($_POST['description'])) {
              $error['description'] ="ban can nhap description";
            }else{
          ...
          $sql="insert into categories values('','$name','$description','$show_menu')";
          $kq=$conn->exec($sql);
          if ($kq==1) {
            echo "thanh cong";
          }else{
