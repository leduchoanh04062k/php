    ...
    <div class="content-wrapper">
      <div class="content">            
        ...
        <div class="container">
          ...
          <div> <h3 style="float:left;">Name : 

            <?php 
            include 'db.php';
            $sqldm = "select * from products where id = '$_GET[product_id]'";
            $kqdm = $conn->query($sqldm)->fetch();
            if($_GET['product_id'] == $kqdm['id']){
              echo $kqdm['name'];
            }
            ?> </h3> <a style="float:right;color: red !important" href="comment.php">Quay Lại <i class="fas fa-sign-out-alt"></i></a></div>   
                ...
                if(isset($_GET['product_id'])){
                  ...
                  foreach($kq as $key=>$value){
                    ...
                    <tr>
                      ...
                      <td><a href="xoa_comment.php?id_xoa=<?php echo $value['id']; ?>&product_id=<?php echo $product_id; ?>" onclick="return confirm('Bạn có thực sự muốn xóa ?')"><button>XÓA</button></a></td>
                    </tr>
                    <?php
                  }
                }
