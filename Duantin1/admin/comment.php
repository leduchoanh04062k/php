  ...
  <table class="table table-bordered">
    <thead class="bg-primary">
      <tr>
        ...
        <th>New comment date</th>
        <th>Old comment date</th>
        <th>Detail</th>
      </tr>
    </thead>
    <tbody>
      ...
      foreach($kq as $key =>$value){
        ?>
           <tr>
              ...
              <td><?php 
                  $sqldm = "select * from products where id = $value[id]";
              ...
              ?></td>
              <td><?php 
                  $sqlsl = "select * from comments WHERE product_id=$value[id]";
                  $kqdm = $conn->query($sqlsl)->rowCount();
                    echo $kqdm;
              ?> </td>
              <td><?php $sql = "SELECT * FROM comments ORDER BY date DESC";
                      $kq  = $conn->query($sql)->fetch(); 
                      echo $kq['date'];
                      ?></td>
              <td><?php $sql = "SELECT * FROM comments ORDER BY date ASC";
                      $kq  = $conn->query($sql)->fetch(); 
                      echo $kq['date'];
                      ?></td>
              <td> <a href="ctcomments.php?product_id=<?php echo $value['id']; ?>"><button class="btn btn-success">Detail</button></a> </td>
            </tr>
              <?php
          }
      ?>
