      ...
      <table class="table table-bordered">
        ...
        foreach ($kq as $key => $row) {
          ...
          <tr>
            ...
            <th><a href="quyentk.php?id_quyen=<?php echo $row['id'] ?>" onclick="return confirm('ban co muon thay doi quyen  k??')"><input style="color: #0ae619" type="submit" name="roles" value="<?php echo displayStatusForSlide($row['roles']) ?>"></i></a></th>
            <th><a href="xoa_user.php?maxoa=<?php echo $row ['id']?>"><input type="submit" name="" value="Xóa" onclick="return confirm('ban co muon xoa k ?')" ></a></th>
          </tr>
        <?php }
        ?>
      </table>
