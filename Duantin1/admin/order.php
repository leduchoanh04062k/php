          ...
          <table class="table table-bordered">
            ...
            foreach ($kq as $key => $row) {
              ...
              <tr>
                ...
                <th><?php echo $row['customer_phone_number']; ?></th>
                <th><?php echo $row['address']; ?></th>
                <th><?php echo $row['message']; ?></th>
                <td><?php $sql = "SELECT * FROM orders ORDER BY created_date DESC";
                $kq  = $conn->query($sql)->fetch(); 
                echo $kq['created_date'];
                ?></td>
                ...
                <td> <a href="ctorder.php?order_id=<?php echo $row['id']; ?>"><button class="btn btn-success">Detail</button></a> </td>
              </tr>
            <?php }
            ?>
