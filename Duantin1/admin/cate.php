    ...
    <thead class="bg-primary">
     ...
     <?php 
      ...
      foreach ($kq as $key => $row) {
        ?>
        <form action="cate_menu.php" method="POST">
        <tr>
          <input type="hidden" value="<?php echo $row['id'] ?>" name="id" id="">
          <th><?php  echo$key+1; ?></th>
          <th><?php echo $row['name']; ?></th>
          <th><input style="color:#0ae619" type="submit" name="show_menu" value="<?php echo displayStatusForSlide($row['show_menu']) ?>"></th> 
           </form>
          <th><a href="sua_cate.php?masua=<?php echo $row ['id']?>"><input type="submit" name=""
          value="Edit"></a></th>
      <th><a href="xoa_cate.php?maxoa=<?php echo $row ['id']?>"><input type="submit" name="" value="Delete" onclick="return confirm('ban co muon xoa k ?')" ></a></th>
        </tr>
