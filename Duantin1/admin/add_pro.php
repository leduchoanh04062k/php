...
<div class="page-wrapper">
      ...
      <div class="content">						 
       ...
       <form action="" method="POST" enctype="multipart/form-data">
        <div class="row">
          <div class="col-sm-5">  
            ...
            <div class="form-group">
              ...
              <input class="form-control input-sm" id="inputsm"  type="text" name="price">
            </div>  
            <div class="form-group">
              <label for="inputsm">Sale_price</label>
              <input class="form-control input-sm" id="inputsm" type="text" name="sale_price">
            </div>      
            <div class="form-group">
              <label for="inputsm">Feature_image</label>
              <input class="form-control input-sm" id="inputsm" required="" type="file" name="feature_image">
            </div>
            <div class="form-group">
          ...
          <div class="col-sm-7">
            <div id="sample">
              ...
              <textarea name="detail" cols="80"  style="height: 250px;">
              </textarea>
            </div>
            <br>
            <div class="form-group">
              <label for="inputsm">Status</label>
              <select name="status" id="" class="form-control-2">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($_POST['name'])) {
              $error['name'] ="ban can nhap ten";
            }else{
              $name=$_POST['name'];
            }
            if (empty($_POST['price'])) {
              $error['price'] ="ban can nhap price";
            }else{
              $price=$_POST['price'];
            }
            if (empty($_POST['sale_price'])) {
              $error['sale_price'] ="ban can nhap sale_price";
            }else{
              $sale_price=$_POST['sale_price'];
            }
            if (empty($_POST['detail'])) {
              $error['detail'] ="ban can nhap detail";
            }else{
              $detail=$_POST['detail'];
            }
            ...
            $status=$_POST['status'];
            $sql="insert into products values('','$name','','$cate_id','','$price','$sale_price','$detail','$nameA','','status','')";
            $kq=$conn->exec($sql);
           if ($kq==1) {
              echo "thanh cong";
            }else{
  ...
  <footer class="footer mt-auto">
    <div class="copyright bg-white">
      <p>
        &copy; <span id="copy-year">2019</span> Copyright Sleek Dashboard HTT e by
        <a
        class="text-primary"
